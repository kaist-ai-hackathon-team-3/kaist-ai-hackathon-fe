              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 10),
                    Text(policy['supportTarget'],
                        style: const TextStyle(fontSize: 16)),
                    const SizedBox(height: 20),
                    _buildSectionTitle('지원 기간'),
                    const SizedBox(height: 10),
                    Text(policy['applicationDeadline'],
                        style: const TextStyle(fontSize: 16)),
                    const SizedBox(height: 20),
                    _buildSectionTitle('지원 내용'),
                    const SizedBox(height: 10),
                    Text(policy['supportDetails'],
                        style: const TextStyle(fontSize: 16)),
                    const SizedBox(height: 20),
                    _buildSectionTitle('관련 정보'),
                    const SizedBox(height: 10),
                    Text(policy['selectionCriteria'],
                        style: const TextStyle(fontSize: 16)),
                    const SizedBox(height: 20),
                    _buildSectionTitle('신청 방법'),
                    const SizedBox(height: 10),
                    Text(policy['applicationMethod'],
                        style: const TextStyle(fontSize: 16)),
                  ],
                ),
              ),
